  ...
  <div class="table-responsive">
    <table class="mdl-data-table mdl-js-data-table mdl-shadow--2dp full-width table-responsive">
      ...
      <tr>
        ...
        <th class="mdl-data-table__cell--non-numeric">Id. Pago</th>
        <th class="mdl-data-table__cell--non-numeric">Descripción</th>
        <th class="mdl-data-table__cell--non-numeric">Valor total</th>
        <th class="mdl-data-table__cell--non-numeric">Valor recibido</th>
        <th class="mdl-data-table__cell--non-numeric">Cambio</th>
      </tr>
      </thead>
      <tbody>
      <tr>
        ...
        <td class="mdl-data-table__cell--non-numeric">12345</td>
        <td class="mdl-data-table__cell--non-numeric">Silla A2</td>
        <td class="mdl-data-table__cell--non-numeric">5000</td>
        <td class="mdl-data-table__cell--non-numeric">8000</td>
        <td class="mdl-data-table__cell--non-numeric">3000</td>
      </tr>
      </tbody>
    </table>
  </div>
