            ...
            <form>
                <div class="mdl-grid">
                    <div class="mdl-cell mdl-cell--12-col">
                        <legend class="text-condensedLight"><i class="zmdi zmdi-border-color"></i> &nbsp; FUNCIONES DISPONIBLES</legend><br>
                    </div>
                    <div class="mdl-cell mdl-cell--6-col mdl-cell--8-col-tablet">
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                            <select name="" id="genero" class="mdl-textfield__input">
                                <option value="">Seleccione la funcion</option>
                                <option value="">Funcion 1</option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <div class="mdl-tooltip" for="btn-addCompany">Confirmar funcion</div>
                </p>
            </form>
        </div>
    </div>
